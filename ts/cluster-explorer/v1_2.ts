...
export namespace ClusterExplorerV1_2 {
    ...
    export interface NodeContributor {
         ...
         */
        contributesChildren(parent: ClusterExplorerV1_2.ClusterExplorerNodeV2 | undefined): boolean;
        /**
         ...
         */
        getChildren(parent: ClusterExplorerV1_2.ClusterExplorerNodeV2 | undefined): Promise<Node[]>;
    }
    ...
    /**
     * A tree node representing the cluster of the current active context.
     *
     * For attaching commands to a context node, the viewItem
     * context is "vsKubernetes.active.cluster" for normal clusters,
     */
